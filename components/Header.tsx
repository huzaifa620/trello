  ...
  return (
    <header>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center p-5 bg-gray-500/10 rounded-b-2xl">
            ...
            <Image src="https://links.papareact.com/c2cdd5" alt="" width={300} height={100} className="w-44 md:w-56 md:pb-0 object-contain cursor-pointer hover:animate-pulse" />

            <div className="flex items-center space-x-5 flex-1 justify-end max-w-7xl">
                ...
                <Avatar className="cursor-pointer hover:opacity-90" name="M Huzaifa" round color="#0055D1" size="50" />
            </div>
        </div>

        <div className="flex items-center justify-center py-2 px-5 md:py-5">
            <p className="flex items-center p-5 pr-5 shadow-xl rounded-xl w-fit bg-white italic max-w-3xl text-[#0055D1]">
